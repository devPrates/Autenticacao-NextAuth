    ...
    <>
      <section className="space-y-2 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-12">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <div className="flex gap-2">
            {" "}
            <Link
              href={"https://www.linkedin.com/in/devprates/"}
            ...
            <Link
              href={"https://www.instagram.com/gprates404/"}
              className="rounded-2xl bg-muted px-4 py-1.5 text-sm font-medium"
              target="_blank"
            >
              Segue no Instagram
          ...
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
            Projeto com Next.js 14, Next-Auth, Prisma e Shadcn-ui.
          </h1>
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            Projeto desenvolvido por mim para praticar Next.js e Next-Auth e aprender mais sobre autenticação utilizando essa tecnologia!
          </p>
          <div className="space-x-4">
            ...
            <Link
              href="https://github.com/devprates"
              target="_blank"
              rel="noreferrer"
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            ...
            recursos atualizados do Next.js 14 e utilizando a biblioteca shadcn/ui.
          </p>
        </div>
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
           &copy;Todos os direitos reservados. Visite meu {" "}
            <Link
              href={"https://github.com/devprates"}
              target="_blank"
              rel="noreferrer"
